  ...
  return (
    <div className="leaderboard-panel glass-card" style={{ padding: "24px", marginTop: "24px" }}>
      <div className="panel-header" style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
        <span className="panel-icon" style={{ fontSize: "1.3rem" }}>🏆</span>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
          <span style={{ fontSize: '0.78rem', fontWeight: '700', color: '#fff' }}>
            {campaignTime.phase === 'pre' ? '⏳ Campaign Starts In' : campaignTime.phase === 'live' ? '🟢 Campaign LIVE - Ends In' : '🏁 Campaign Ended'}
          </span>
          <span style={{
        ...
        <div style={{ fontSize: '0.72rem', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
          {isMainnet ? (
            <>
              <strong style={{ color: '#FFD700' }}>🏆 Prize Pool:</strong> 100% of Aave V3 USDT yield generated by all deposits during the 2-week campaign.
            ...
            <>
              <strong style={{ color: 'var(--accent-blue)' }}>🏋️ Pre-Season Campaign:</strong> Practice the full flow with testnet USDT before World Cup kicks off.
